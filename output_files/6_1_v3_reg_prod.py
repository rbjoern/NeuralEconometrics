...
parameters = {} 
#Generel set-up
parameters['seed'] = 12661               #Seed for pseudo-random draws            
parameters['M'] = 100                #Number of simulation repetitions
parameters['k'] = 3                   #Number of regressors
...
parameters['filename'] = '6_2_v3_reg_prod_' +  str(datetime.date(datetime.now())).replace('-','_')
...
#changing_parameter['parameter_space'] = [n for n in range(int(5*10**2), 10**3, int(5*10**2))] \
