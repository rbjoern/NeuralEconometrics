...
parameters = {}
#Generel set-up
parameters['seed'] = 4598               #Seed for pseudo-random draws            
...
parameters['C'] = 4                     #Number of confounding variables 
...
parameters['filename'] = '6_1_v2_reg_prod_' +  str(datetime.date(datetime.now())).replace('-','_')
