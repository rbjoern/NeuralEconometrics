...
parameters['n'] = 2*10**5             #Number of observations 
parameters['C'] = 3                     #Number of confounding variables 
...
parameters['filename'] = '6_2_v2_reg_prod_' +  str(datetime.date(datetime.now())).replace('-','_')
